...
@section('title',__('Sửa Chi Tiết Thiết Bị'))
@section('content')
@php 
    ...
    <section class="content">
        <div class="container">
            <div class="head">
                ...
                <h1 class="title">{{ __('Sửa Chi Tiết Thiết Bị') }}</h1>
            </div>
            <div class="main">
                            ...
                            <div class="form-group" id="ClassId">
                                ...
                                <select class="select2 form-control" name="equipment_device[]" multiple="multiple"  >
                                    @foreach ($devices as $device)
                                        <option {{ in_array($device->id, $array) ? ' selected' : '' }} value="{{$device->id}}">{{$device->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
